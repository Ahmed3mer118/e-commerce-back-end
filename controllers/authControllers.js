...
exports.register = (role) => {
  return catchAsync(async (req, res, next) => {
    ...
    const user = await User.create({ username, email, password : hashedPassword, phoneNumber, role, verificationCode });
...
exports.login = async (req, res) => {
  try {
    ...
    const user = await User.findOne({ $or: [{ email }, { phoneNumber: phoneNumber }] });
    if (!user) {
